...
public class AirLinesRanking {

	private static final Log LOG = LogFactory.getLog(AirLinesRanking.class);
...
//			LOG.info("AirportOrigDestCntMap value:" + value);
	...
	public static void main(String[] args) throws Exception {
		...
		jobA.setJarByClass(AirLinesRanking.class);
		...
		jobB.setJarByClass(AirLinesRanking.class);
		...
		jobC.setJarByClass(AirLinesRanking.class);
