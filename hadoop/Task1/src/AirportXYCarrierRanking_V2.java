...
public class AirportXYCarrierRanking_V2 {

	private static final Log LOG = LogFactory.getLog(AirportXYCarrierRanking_V2.class);
...
//			LOG.info("AirportOrigDestCntMap value:" + value);
	...
	public static void main(String[] args) throws Exception {
		...
		jobA.setJarByClass(AirportXYCarrierRanking_V2.class);
		...
		jobB.setJarByClass(AirportXYCarrierRanking_V2.class);
		...
		jobC.setJarByClass(AirportXYCarrierRanking_V2.class);
